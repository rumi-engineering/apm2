...
- [rust-textbook Chapter 15: Paths, Filesystem, OS](../../.claude/skills/rust-textbook/15_paths_filesystem_os.md) - Path handling for `cwd`
- [rust-textbook Chapter 11: Async, Pin, Cancellation](../../.claude/skills/rust-textbook/11_async_pin_cancellation.md) - Async process operations
