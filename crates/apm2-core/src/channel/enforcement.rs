...
pub struct ChannelBoundaryCheck {
    ...
    /// RFC-0032::REQ-0216: Decoded token binding contract fields (if present).
...
/// Token binding contract fields for RFC-0032::REQ-0216 (RFC-0028).
///
...
struct ChannelContextTokenPayloadV1 {
    ...
    /// RFC-0032::REQ-0216: Token binding contract fields.
    #[serde(default)]
...
pub enum ChannelContextTokenError {
    ...
    /// Token intent does not match the expected intent (RFC-0032::REQ-0218).
    ///
...
pub struct ChannelBoundaryDefect {
    ...
    pub detail: String,
    /// Structured budget denial receipt (RFC-0032::REQ-0219, INV-CPRL-003).
    ///
...
impl ChannelBoundaryDefect {
    ...
    /// (RFC-0032::REQ-0219, INV-CPRL-003).
    #[must_use]
...
/// Expected token binding values for RFC-0032::REQ-0216 validation.
///
...
pub fn decode_channel_context_token_with_binding(
    ...
    // RFC-0032::REQ-0216: Validate token binding contract fields when expected.
    if let Some(expected) = expected_binding {
        ...
        // RFC-0032::REQ-0218: Validate intent binding (fail-closed).
...
mod tests {
    ...
    // -----------------------------------------------------------------------
    // RFC-0032::REQ-0216: Token binding contract tests
    // -----------------------------------------------------------------------
    ...
    // -----------------------------------------------------------------------
    // RFC-0032::REQ-0218: Intent taxonomy — kind/intent mismatch denial
    // -----------------------------------------------------------------------
