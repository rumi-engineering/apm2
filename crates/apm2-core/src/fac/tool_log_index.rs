...
//!
//! This module implements [`ToolLogIndexV1`] per RFC-0032::REQ-0120 and
//! RFC-0019. The index provides a single-pointer audit surface for tool
//! executions within an episode.
//!
//! # Design Overview
//!
