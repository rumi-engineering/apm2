...
pub fn run_pipeline(repo: &str, pr_number: u32, sha: &str, json_output: bool) -> u8 {
    // RFC-0032::REQ-0245: Fail-fast credential gate for GitHub-facing pipeline command.
...
fn run_pipeline_inner(
    ...
    // RFC-0032::REQ-0200: resolve workspace via mirror checkout to an isolated lane,
