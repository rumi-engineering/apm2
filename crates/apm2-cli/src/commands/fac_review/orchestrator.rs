...
fn build_missing_verdict_nudge_message(
    ...
    format!(
        "RESUME TASK - REQUIRED TERMINAL COMMAND NOT EXECUTED.\n\
         ...
         {command}\n\n\
         Use your existing session context and execute this verdict command now.\n\n\
...
#[cfg(test)]
mod tests {
    use super::{ReviewKind, build_missing_verdict_nudge_message, required_verdict_command};
    ...
    #[test]
    fn build_missing_verdict_nudge_message_embeds_required_command_without_prompt_excerpt() {
        ...
        assert!(message.contains("Use your existing session context"));
    }
}
