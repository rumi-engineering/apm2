...
- TCK-00638: RFC-0032 Phase 2 PublishWorkContextEntry handler (IPC-PRIV-077) -- CAS-first storage, `evidence.published` ledger anchor, deterministic `CTX-` entry ID derivation, `work_context` projection
