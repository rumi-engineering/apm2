...
- [ ] **Shell commands with complex strings?** Use file-based input, not argument passing
- [ ] **Temp files?** Use `tempfile` crate, never predictable names
- [ ] **Adding struct fields?** Update ALL variants and match arms exhaustively
...
| [SAFE_RUST_PATTERNS.md#anti-patterns](references/SAFE_RUST_PATTERNS.md#anti-patterns-lessons-learned) | Reviewing code; avoid repeating past mistakes (shell escaping, temp files, incomplete updates) |
