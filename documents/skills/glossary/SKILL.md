---
name: glossary
description: REQUIRED. Always consult this skill to define project-specific acronyms (CCP, AAT, CAS) and Holonic terminology before planning or writing code.
...
| Work Substrate | references/work_substrate.md |